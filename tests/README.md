# Kafka.Consumer.Resilient - Tests

This directory contains comprehensive unit and integration tests for the Kafka.Consumer.Resilient library.

## 📁 Structure

```
tests/
├── Kafka.Consumer.Resilient.Tests.Unit/          # Unit tests
│   ├── RetryTopicNamingStrategyTests.cs
│   ├── RetryTopicConfigurationTests.cs
│   ├── ConfigurationValidationTests.cs
│   └── RetryMetadataTests.cs
│
├── Kafka.Consumer.Resilient.Tests.Integration/   # Integration tests with real Kafka
│   ├── Fixtures/
...
│
└── Kafka.Consumer.Resilient.Tests.AppHost/       # Aspire AppHost for infrastructure
    └── Program.cs
```
...
# Run only unit tests
dotnet test tests/Kafka.Consumer.Resilient.Tests.Unit/

# Run only integration tests
dotnet test tests/Kafka.Consumer.Resilient.Tests.Integration/
